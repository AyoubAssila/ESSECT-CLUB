<?php
require_once "model/CondidateEnactus.php";
...
class CandidatureController {
     ...
     */
    public function submitCandidatureEnactus($data, $file) {
        try {
            ...
            $query = "INSERT INTO condidatenactus (cin, nom, prenom, email, departement, motivation, experience, experienceDetails, competences, disponibilite, idee, cvFilePath) 
            ...
            return ["success" => "Candidature soumise avec succès pour Enactus."];
