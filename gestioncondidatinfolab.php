<?php
require_once "model/CondidateInfolab.php";
...
class CandidatureController {
     ...
     */
    public function submitCandidatureInfolab($data, $file) {
        try {
            ...
            $query = "INSERT INTO condidatinfolab (cin, nom, prenom, email, departement, motivation, experience, experienceDetails, competences, disponibilite, idee, cvFilePath) 
            ...
            return ["success" => "Candidature soumise avec succès pour Infolab."];
