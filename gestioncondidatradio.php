<?php
require_once "model/CondidateRadio.php";
...
class CandidatureController {
     ...
     */
    public function submitCandidatureRadio($data, $file) {
        try {
            ...
            $query = "INSERT INTO condidatradio (cin, nom, prenom, email, departement, motivation, experience, experienceDetails, competences, disponibilite, idee, cvFilePath) 
            ...
            return ["success" => "Candidature soumise avec succès pour Radio."];
